...
function crearDataTable() {
	  ...
	  // $('#lista_alu_cat').DataTable(); //datateble original
	$('#lista_alu_cat').dataTable({ //datatable personalizado
		"columnDefs": [
            {
                "targets": [ 5 ],
                "visible": false,
	...
	$('#lista_alu_cat').removeClass('display')
		.addClass('table table-striped table-bordered');

	var table = $('#lista_alu_cat').DataTable();
 
	$('#lista_alu_cat tbody tr').click(
		// function () {
