...
function crearDataTable() {
	  ...
	  // $('#lista_guias').DataTable(); //datateble original
	$('#lista_guias').dataTable({ //datatable personalizado
		"columnDefs": [
            {
                "targets": [ 4,5 ],
                "visible": false,
            ...
            },
            {
            	...
            	"createdCell": function (td, cellData, rowData, row, col) {
      				var newData = '';
  					 ...
  					 newData += '<div class="boton-modificar"><a href="'+rowData[4]+'" class="btn btn-warning btn-xs" data-toggle="tooltip" data-placement="bottom" title="Modificar datos" ><span class="glyphicon glyphicon-pencil grande"></span> </a></div>';
	...
	$('#lista_guias').removeClass('display')
		.addClass('table table-striped table-bordered');

	var table = $('#lista_guias').DataTable();
 
	$('#lista_guias tbody tr').click(
		function () {
