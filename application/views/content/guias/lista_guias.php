...
<!-- JS de esta vista -->
<script type="text/javascript"  src="<?php echo base_url('assets/js/guias/lista_guias.js'); ?>"></script>
<!-- DataTables JS-->
...
<div id="lista-guias" >
  <a id="btn-agregar" href="<?php echo site_url('crear_nueva_guia/crear');?>" class="btn btn-primary ">Agregar nueva</a> 
  <div class="row">
